...
| [ADR-0004: 축산 리포트 공통 지도 템플릿과 지연 로딩](./ADR-0004-shared-livestock-report-map-template.md) | 2026-09-01 | Accepted | 한우·한돈 리포트가 공통 섹션 프레임과 축종별 질병 지도 슬롯을 사용하고, 지도 코드·데이터는 해당 슬롯이 화면에 가까워질 때 로드한다. |
