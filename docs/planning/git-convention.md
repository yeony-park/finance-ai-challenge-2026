...
| 삭제 완료 | `yeonjeong` (8/8, 미사용 보험 아이디어·소유자 승인) | ✅ 8/31 로컬·원격 브랜치와 `archive/yeonjeong` 태그 삭제 |
...
| 아카이브 태그 후 보류 | `Su`(8/15), `docs/pig-sto-research`(8/15) | ✅ `archive/<이름>` 태그 푸시 완료 — 소유자가 자산 회수 확인해주면 브랜치 삭제 |
...
| 날짜 | 내용 |
| --- | --- |
| 2026-08-31 | `yeonjeong`의 미사용 보험 아이디어와 로컬 전용 미술 제안서 폐기 승인 후 브랜치·아카이브 태그 삭제 |
