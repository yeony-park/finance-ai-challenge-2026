const FILING_HEADING_ID = "report-filing-heading";
const HISTORY_HEADING_ID = "report-history-heading";
const PRICE_HEADING_ID = "report-price-heading";
const REALITY_HEADING_ID = "report-reality-heading";
const TRACK_RECORD_HEADING_ID = "report-track-record-heading";
const VERDICT_HEADING_ID = "report-verdict-heading";
const WATCH_HEADING_ID = "report-watch-heading";
