...
-- 목적: 런타임 조회는 RAG와 offerings의 공개 응답 열로, 쓰기는 실행 이력 INSERT로만 격리한다(09 §2.1·§5).
-- offerings의 비공개 열·art_auction_records·re_trades·원장 쓰기·마이그레이션 권한은 이 역할에 부여하지 않는다. 그 권한은 CLI 전용 DATABASE_URL_DIRECT 자격증명에만 남긴다.
--
