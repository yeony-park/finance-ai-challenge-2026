...
class T(unittest.TestCase):
 ...
 def test_static_allowlist(self):
  ...
  try:
   for path,expected in [('/index.html',200),('/search.html',200),('/suitability.html',200),('/styles.css',200),('/js/app.js',200),('/js/track-records.js',200),('/data/products.json',200),('/data/issuers.json',200),('/data/artnguide_track_records.json',200),('/data/weshareart_research.json',200),('/data/tessa_sale_records.json',200),('/server.py',404),('/data/source_snapshots.json',404),('/data/artnguide_due_diligence.json',404),('/data/artnguide_evidence_sources.json',404),('/deliverables/artnguide_artwork_track_records_2026-08-10.md',404),('/deliverables/artnguide_due_diligence_evidence_2026-08-10.md',404),('/tests',404),('/js/../server.py',404)]:
