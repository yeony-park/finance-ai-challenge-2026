...
export default async function ProductsPage({ searchParams }: Props) {
  ...
  return <main id="main-content" className="listing-page"><PageContainer>
    ...
    <form className="simple-search" role="search">
      ...
      <input id="catalog-keyword" name="keyword" defaultValue={keyword} placeholder="예 : 김환기, 아트투게더, 청산 완료" />
    ...
    <div className="listing-layout">
      ...
      <section className="listing-results" aria-live="polite">
        ...
        {scope !== "current" ? <p className="table-note">과거 필터 집계 : {historicalAggregate.total}건 · 매각 완료 {historicalAggregate.byLifecycle.sold}건 · 반환 {historicalAggregate.byLifecycle.returned}건 · 매각 진행 {historicalAggregate.byLifecycle.exit_in_progress}건 · 원본 상태와 출처는 상세에서 확인</p> : null}
