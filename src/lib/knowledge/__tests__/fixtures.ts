...
export const validScenarioOffer = () => ({
  ...
  investorProtection: {
    ...
    basis: "scenario-input" as const,
    rightForm: {
      statement: "시나리오상 투자자는 전자등록 수익권 단위를 보유합니다.",
      status: "confirmed-in-scenario" as const,
      dataNature: "scenario" as const,
      basis: "scenario-input" as const,
      limitations: ["실제 권리의 법적 효력을 확인한 내용이 아닙니다."],
    },
    fundsSafekeeping: {
      statement: "시나리오상 청약대금은 별도 수탁계정에 보관됩니다.",
      status: "confirmed-in-scenario" as const,
      dataNature: "scenario" as const,
      basis: "scenario-input" as const,
      limitations: ["실제 수탁계약을 확인한 내용이 아닙니다."],
    },
    bankruptcyRemoteness: {
      statement: "시나리오상 발행인 고유재산과 분리해 관리합니다.",
      status: "confirmed-in-scenario" as const,
      dataNature: "scenario" as const,
      basis: "scenario-input" as const,
      limitations: ["실제 파산 시 재산 분리에 관한 법률의견이 아닙니다."],
    },
    rightsAdministration: {
      statement: "시나리오상 권리자 명부와 분배내역을 별도 관리합니다.",
      status: "confirmed-in-scenario" as const,
      dataNature: "scenario" as const,
      basis: "scenario-input" as const,
      limitations: ["실제 권리관리 계약을 확인한 내용이 아닙니다."],
    },
    disputeResolution: {
      statement: "시나리오상 이의신청과 분쟁조정 절차를 안내합니다.",
      status: "confirmed-in-scenario" as const,
      dataNature: "scenario" as const,
      basis: "scenario-input" as const,
      limitations: ["실제 분쟁 해결 결과를 보장하지 않습니다."],
    },
    issuanceDistributionSeparation: {
      statement: "시나리오상 발행과 유통 운영 주체의 역할을 구분합니다.",
      status: "confirmed-in-scenario" as const,
      dataNature: "scenario" as const,
      basis: "scenario-input" as const,
      limitations: ["실제 업무분장 계약을 확인한 내용이 아닙니다."],
    },
  },
  offering: {
