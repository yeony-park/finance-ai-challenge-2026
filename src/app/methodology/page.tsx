...
export const metadata: Metadata = {
  title: "검증 방법",
  description:
    "증권신고서의 주장을 어떤 공공 데이터와 대조하는지, 판정 3값(일치 / 원장에서 확인되지 않음 / 확인 불가)의 정의는 무엇인지, 무엇을 하지 않는지 정리했습니다.",
};
...
const VERDICTS: readonly Term[] = [
  ...
  {
    term: "확인 불가",
    desc: "대조할 공공 데이터가 없거나 아직 연결되지 않은 항목입니다. 일치·불일치 어느 쪽으로도 세지 않고, 집계에서 따로 표시합니다.",
...
const PRINCIPLES: readonly Rule[] = [
  {
    term: "단정하지 않습니다",
    desc: "불일치의 원인을 지목하거나 발행사의 의도를 규정하는 표현을 쓰지 않습니다. 대조 결과를 세 값 중 하나로 적는 것이 이 서비스가 할 수 있는 전부입니다.",
  },
  {
  ...
  },
  {
    ...
    desc: "확인할 자료가 없다는 사실과 내용이 사실이 아니라는 판단은 다릅니다. 누락된 값은 채워 넣지 않고 비워 두거나 확인 불가로 남깁니다.",
  },
  {
    term: "익명화가 기본입니다",
